										...
										<div className="tab-content">
										  <div className="tab-pane active" id="men">
											<ul className="nav-list list-inline">
												<li><a href="women.html"><img src="images/t7.jpg" className="img-responsive" alt=""/></a></li>
												<li><a href="women.html"><img src="images/t8.jpg" className="img-responsive" alt=""/></a></li>
												<li><a href="women.html"><img src="images/t9.jpg" className="img-responsive" alt=""/></a></li>
												<li><a href="women.html"><img src="images/t11.jpg" className="img-responsive" alt=""/></a></li>
												<li><a href="women.html"><img src="images/t1.jpg" className="img-responsive" alt=""/></a></li>
								...
								<div className="dropdown-menu mega-dropdown-menu">
									<div className="container-fluid">
										<div className="tab-content">
										  <div className="tab-pane active" id="men">
											<ul className="nav-list list-inline">
												<li><a href="men.html"><img src="images/t10.jpg" className="img-responsive" alt=""/></a></li>
												<li><a href="men.html"><img src="images/t2.jpg" className="img-responsive" alt=""/></a></li>
												<li><a href="men.html"><img src="images/t3.jpg" className="img-responsive" alt=""/></a></li>
												<li><a href="men.html"><img src="images/t4.jpg" className="img-responsive" alt=""/></a></li>
												<li><a href="men.html"><img src="images/t5.jpg" className="img-responsive" alt=""/></a></li>
												<li><a href="men.html"><img src="images/t6.jpg" className="img-responsive" alt=""/></a></li>
											</ul>
										  </div>
